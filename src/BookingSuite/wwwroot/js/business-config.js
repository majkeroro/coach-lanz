/* ============================================================
   ...
   NOTE (full-stack): the live catalog now comes from the server
   (window.SERVER_CONFIG). This file only provides the business-type
   PRESETS used by Services preview + Admin setup. Defaults below
   are used only when the backend is unreachable (static demo mode).
   ============================================================ */
